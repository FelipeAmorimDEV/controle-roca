...
import { testSugestoesGlobais } from './controllers/ai-suggestions/test-sugestoes-globais'
...
// Debug fases de um setor específico
app.get(
...
// Teste de sugestões globais
app.get(
  '/ai/test-sugestoes-globais',
  { onRequest: [verifyJWT] },
  testSugestoesGlobais,
)
}
